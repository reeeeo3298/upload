...
<div class="content-block">
    ...
    <div class="img-block">
        <figure><img id="zoom" src="../wordpress/upload_citygas/{{$accept_no}}/img.{{$file_type}}"></figure>
        <div class="conplete_btn_block">
            <button type="button" formaction="add_complete" name="complete" class="btn btn-primary btn-lg complete_citygas_btn">登録完了</button>
        </div>
        <div class="hold_btn_block">
            <button type="button" formaction="hold_complete" name="hold" class="btn btn-success btn-lg hold_citygas_btn">登録保留</button>
        </div>
    </div>
