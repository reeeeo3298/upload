$(function(){
    ...
    //都市ガス完了ボタン
    $('.complete_citygas_btn').click(function(){
        if(!confirm('登録完了でよろしいですか？')){
        return false;
        }else{
        /*　OKの時の処理 */
        $('#customer_data').attr('action','/Lpio_upload/add_citygas_complete');
        $('#customer_data').submit();
        }
    });
    ...
    //都市ガス保留ボタン
    $('.hold_citygas_btn').click(function(){
        if(!confirm('登録を保留しますか？')){
        return false;
        }else{
        /*　OKの時の処理 */
        $('#customer_data').attr('action','/Lpio_upload/hold_citygas_complete');
        $('#customer_data').submit();
        }
    });
